...
export const metadata: Metadata = {
  title: 'Course Registrations | SIAK Dashboard',
  description: 'Student course registration analytics'
};
...
export default async function RegistrationsPage({
  ...
  const searchParamString = new URLSearchParams({
    ...
    ...(searchParams?.minCredits && { minCredits: searchParams.minCredits }),
    ...(searchParams?.maxCredits && { maxCredits: searchParams.maxCredits }),
  }).toString();
  ...
  try {
    ...
    const apiUrl = `${host}/api/warehouse/registrations?${searchParamString}`;
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            <div className="mb-6 lg:mb-8">
              ...
              <p className="mt-2 text-sm sm:text-base text-gray-400">
                Monitor and analyze student course registration data
              </p>
            </div>
            
            <RegistrationList 
              registrationData={data.registrations || { data: [], total: 0, page: 1, pageSize: 10, totalPages: 0, faculties: [], programs: [], stats: { totalRegistrations: 0, totalStudents: 0, totalCourses: 0, averageCredits: 0 } }}
        ...
        <div className="min-h-screen bg-gray-950" style={{ backgroundColor: '#030712' }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            ...
            <div className="bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-8 text-center">
              <div className="text-red-400 text-lg mb-2">Failed to load registration data</div>
